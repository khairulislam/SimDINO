...
NAME = "simdinov2"
DESCRIPTION = "PyTorch code and models for the SimDINOv2 self-supervised learning method."

URL = "https://github.com/RobinWu218/SimDINO"
AUTHOR = "Ziyang Wu"
...
def get_package_version() -> str:
    with open(HERE / "simdinov2/__init__.py") as f:
